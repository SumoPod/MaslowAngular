...
import { EVETokenContractAddress, MaslowPyramidID, VelTraderContractAddress_v42, VelTraderContractAddress_v7, WorldAddress } from '../../eve-wallet-service/eve-wallet-constants';
...
export class SellableItemComponent {
  ...
  doSellItems()
  {
    this.maslow.wallet.approveEVE(VelTraderContractAddress_v42, this.totalValue)
    .then(() => {
